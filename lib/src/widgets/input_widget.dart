...
class InternationalPhoneNumberInput extends StatefulWidget {
  ...
  InternationalPhoneNumberInput({
    ...
    this.selectorButtonOnErrorPadding = 24.0,
    this.spaceBetweenSelectorAndTextField = 12.0,
    this.maxLength = 15,
    this.isEnabled = true,
...
class _InputWidgetState extends State<InternationalPhoneNumberInput> {
        ...
        if (phoneNumber == null) {
          if (widget.onInputChanged != null) {
            widget.onInputChanged!(
              PhoneNumber(
                phoneNumber: parsedPhoneNumberString.replaceAll(
  ...
  void onCountryChanged(Country? country) {
    setState(() {
      this.country = country;
      this.controller?.text = country?.dialCode ?? '';
    });
    phoneNumberControllerListener();
  }
